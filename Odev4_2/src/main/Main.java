...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Gamer fakeGamer1 = new Gamer("1", "Samet", "Acar", "acaarsamet@gmail.com", 1500, "123456", "12345", "20.07.2000");
        Game game = new Game("1", "RedAlert2 ", 150);
        BaseGamerService gamerCheckService = new EdevletManager(new GamerCheckAdapter(realGamer.getFirstName(), realGamer.getNationaltyID(), realGamer.getDateOfBirth()));
